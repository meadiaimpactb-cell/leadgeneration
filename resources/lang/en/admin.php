...
return [
    ...
    'section_type_hint_segment_cta' => 'A navy band with one button that scrolls to the contact form and records the segment. It carries no form — the site has exactly one.',
