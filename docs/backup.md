...
> **الحالة:** المهمة مغلقة ومنفَّذة، لا موثَّقة فقط. المهمة اليومية مسجَّلة وتعمل
> (آخر تشغيل عبر المجدول بنتيجة `0`)، والتدوير مُثبَت على تسع دورات، واختبار
> الاستعادة نُفِّذ فعليًا على `amadcraft_b2b_test` — 56 جدولًا تطابقت صفوفها مع
> فحص MD5 للنص العربي. المخرجات كاملة أدناه.
>
> **آخر اختبار استعادة ناجح: 2026-08-12.** أعيدوا تشغيله بعد أي تغيير في بنية
> قاعدة البيانات: `scripts/restore-db.ps1` بلا وسائط.
